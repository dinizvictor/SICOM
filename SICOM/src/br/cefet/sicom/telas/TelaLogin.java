...
public class TelaLogin extends JFrame {
	...
	public TelaLogin() {
		...
		JLabel lblSepat = new JLabel("SEPAT - Controle de Materiais");
		...
		labelBD = new JLabel("");
		if(Conexao.isConectado()){
			labelBD.setIcon(new ImageIcon(TelaLogin.class.getResource("/br/cefet/sepat/img/bdgood.png")));
		}
		else{
			labelBD.setIcon(new ImageIcon(TelaLogin.class.getResource("/br/cefet/sepat/img/bdbad.png")));
		}
